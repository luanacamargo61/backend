...
namespace _19_Atividade_CRUD.Controllers
{
    public class JogoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JogoId,Nome,Descricao,Imagem,Ativo,CategoriaId")] Jogo jogo)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "CategoriaId", "CategoriaId", jogo.CategoriaId);
            return View(jogo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JogoId,Nome,Descricao,Imagem,Ativo,CategoriaId")] Jogo jogo)
        {
            if (id != jogo.JogoId)
            {
                return NotFound();
